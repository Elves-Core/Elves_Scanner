...
ELVES_CORE_BANNER = 'Elves Core v2.1 by Ishan Nim'
...
class ElvesCore(object):
    ...
    def exit(self):
        self.stats()
        print("Shutting down Elves Core")
    ...
    def stats(self):
        ...
        try:
            if self.counter[0] > 0 or self.counter[1] > 0:
                ...
                print("{0} Elves Core strikes hit. ({1} Failed)".format(self.counter[0], self.counter[1]))
...
class Striker(Process):
    ...
    def getUserAgent(self):
        ...
        'browser_info' in platform and platform['browser_info']:
...
def usage():
    ...
    print(ELVES_CORE_BANNER)
    print()
    print(' USAGE: ./elves_core.py <url> [OPTIONS]')
    print()
    print(' OPTIONS:')
...
def main():
    ...
    try:
        ...
        elves_core = ElvesCore(url)
        elves_core.useragents = useragents
        elves_core.nr_workers = workers
        elves_core.method = method
        elves_core.nr_sockets = socks
